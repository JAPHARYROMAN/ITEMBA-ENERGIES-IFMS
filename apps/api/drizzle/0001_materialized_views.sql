...
-- Ported from the pre-squash 0005_materialized_views migration; these views are
-- not part of the Drizzle ORM schema, so they must be created via raw SQL here.
