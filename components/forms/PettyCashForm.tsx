...
export const PettyCashForm: React.FC<{ onSuccess: () => void; onCancel: () => void }> = ({
  onSuccess,
  onCancel,
}) => {
          ...
          actions={
            <PermissionGuard permissions={permissionGroups.expensesWrite}>
              ...
              <button
                ...
                className={`px-8 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest shadow-xl transition-all ${
                  activeMode === 'Top-up'
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-7 space-y-10">
              ...
              <FormSection
                ...
                description={`Capturing funds ${activeMode === 'Top-up' ? 'received into' : 'discharged from'} safe.`}
              >
                ...
                <div className="md:col-span-2">
                  <TextareaField
                    ...
                    required
                    placeholder="Detailed reason for this transaction..."
                    fullWidth
                  />
                </div>
              </FormSection>
            ...
            <aside className="lg:col-span-5 space-y-6">
              <div className="p-8 bg-slate-900 text-white rounded-3xl shadow-2xl relative overflow-hidden flex flex-col items-center justify-center text-center group">
                ...
                {loadingBalance ? (
                  <div className="h-10 w-32 bg-white/10 animate-pulse rounded"></div>
                ) : (
                ...
                <p className="text-[10px] text-slate-400 font-bold mt-4 uppercase">
                  Verified balance in terminal safe
                </p>
              </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-[11px] text-muted-foreground leading-relaxed">
                      Petty cash spend is limited to{' '}
                      <span className="font-bold text-foreground">$100</span> per single item.
                      Greater amounts must use the main{' '}
                      <span className="font-bold">Expense Terminal</span>.
                    </p>
                  </div>
                </div>
              </div>
